...
# Configuration du logging pour suivre les erreurs par heure lors du chargement des données sur Supabase
...
# Assuming jointure.df_merge_tot is a valid DataFrame
df = jointure.df_merge_tot

# Convertir les colonnes de type numérique en float
